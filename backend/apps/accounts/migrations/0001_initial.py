    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(choices=[('owner_manager', 'owner_manager'), ('admin', 'admin'), ('sales', 'sales'), ('operations', 'operations'), ('accountant', 'accountant'), ('technician', 'technician'), ('driver', 'driver'), ('cashier', 'cashier'), ('viewer', 'viewer')], max_length=50, unique=True)),
